...
{
    public class IPasswordServiceTests
    {
        private readonly IPasswordService _passwordService;

        public IPasswordServiceTests()
        {
            // Suponiendo que existe una implementación llamada PasswordService
            _passwordService = new AbankAPI.Services.PasswordService();
        }
